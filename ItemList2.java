...
public class ItemList2 {
        ...
        public static String[] getitemcodes(){
            ...
            Object[] objects = ItemList2.itemcodes;
        ...
        public static Float[] getamount(String[] args){
            ...
            try {
                ...
                for (int i = 0; i < args.length; i++) {
                        ...
                        int itemindex = findstringindex(ItemList2.itemcodes, args[i]);
                        
                        if (num% 1 != 0 && (ItemList2.types[itemindex] == "A")){
                            System.out.println(ItemList2.itemnames[itemindex] + " ürünü adetle satılmaktadır lütfen tam sayı girin"); 
                            return getamount(args); 
                        }
        ...
        public static void calculateData(String[] items, Float[] amount){
            ...
            for (int i = 0; i < items.length; i++) {
                ...
                indexes[i] = findstringindex(ItemList2.itemcodes, items[i]);
            }
            int indexcounter =  0;
            for ( int i: indexes) {
            ...
            for (int i = 0; i < items.length; i++) {
                float price =  ItemList2.itemprices[indexes[i]];
                float mass = ItemList2.masses[indexes[i]];
            ...
            for (int i = 0; i < sortedData.length; i++) {
                ...
                System.out.println(ItemList2.itemnames[sortedIndex]+" : "+sortedValue + " $");
            }
            ...
            for (int i = (sortedData.length-1); i >= startvalue; --i) {
                ...
                System.out.println(ItemList2.itemcodes[sortedIndex]+": "+sortedValue + " kg");
            }
            ...
            if (compare == " üstünde")     {
                ...
                if (!aexist) {
                   ...
                   while (extramass > 0f) {
                        ...
                        itemamountsbyindex[masskeys[itemcount]] -= 1;
                   ...
                   int coun = 0;
                   for (int i: masskeys){
                    if (itemstoremove[coun] == 0) {
                        break;
                    }
                    System.out.println(ItemList2.itemnames[i]+" : "+itemstoremove[coun]);
                    coun ++;
